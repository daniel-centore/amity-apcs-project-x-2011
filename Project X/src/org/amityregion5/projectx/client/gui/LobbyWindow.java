...
public class LobbyWindow extends JFrame implements MessageListener {
    ...
    private void initComponents()
    {
        ...
        BackToServerChooserButton.setText("Back to Server Chooser");
